            ...
            */
            ...
            while (wall.size() != 0 && banker.playing) {
                ...
                pengButton.addActionListener(e -> {
                    ...
                    if (pengButton.getModel().isArmed()) {
                        banker.cardCalling(south.abandonArea.get(south.abandonArea.size() - 1), String.valueOf(command));
                        banker.cardCalling(west.abandonArea.get(west.abandonArea.size() - 1), String.valueOf(command));
                        panel.updateUI();
                        jf.repaint();
                    }
                });
                ...
                if (!banker.ifCalling && !west.ifCalling && !north.ifCalling) {
                    ...
                    String s_abandoned = south.abandonArea.get(banker.abandonArea.size() - 1);
                        ...
                        new Thread(() -> {
                            ...
                            do {
                                ...
                                for (JButton jButton : buttonArr) {
                                    ...
                                    if (jButton.getModel().isArmed() & Objects.equals(jButton.getActionCommand(), "碰")) {
                        ...
                        new Thread(() -> {
                            ...
                            do {
                                ...
                                for (JButton jButton : buttonArr) {
                                    ...
                                    if (jButton.getModel().isArmed() & Objects.equals(jButton.getActionCommand(), "碰")) {
                                        banker.cardCalling(n_abandoned, String.valueOf(command));
                                        panel.removeAll();
                                        panel.updateUI();
                                        jf.repaint();
                                        System.out.println("button被按下了");
            ...
            if (agari.winNum == 10 || agari.winNum == 5) {
